...
const resources: Record<Locale, Record<string, string>> = {
  de: {
    ...
    "settings.bg.vines": "Ranken",
    "settings.bg.night": "Nacht",
    "settings.bg.jungle": "Dschungel",
    "settings.bg.greenhouse": "Gewächshaus",
  ...
  en: {
    ...
    "settings.bg.vines": "Vines",
    "settings.bg.night": "Night",
    "settings.bg.jungle": "Jungle",
    "settings.bg.greenhouse": "Greenhouse",
