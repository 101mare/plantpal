...
const resources: Record<Locale, Record<string, string>> = {
  de: {
    ...
    "spross.stageLabel": "Stufe {n} von 6 · {name}",
    "spross.vitality": "Vitalität {n} (Bestwert)",
    "spross.nextAt": "Nächste Stufe ab {n}",
    "spross.maxStage": "Höchste Stufe erreicht",
    "spross.formula":
      "Vitalität = Pflege-Qualität × Verweildauer. Pflege wächst mit Konsistenz & Streak, Verweildauer mit dem Alter deiner ältesten Pflanze.",
  ...
  en: {
    ...
    "spross.stageLabel": "Stage {n} of 6 · {name}",
    "spross.vitality": "Vitality {n} (best)",
    "spross.nextAt": "Next stage at {n}",
    "spross.maxStage": "Top stage reached",
    "spross.formula":
      "Vitality = care quality × tenure. Care grows with consistency & streak, tenure with the age of your oldest plant.",
